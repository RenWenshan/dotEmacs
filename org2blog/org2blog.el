...
(defun wenshan-retrieve-html-body (html-text)
        ...
        (save-excursion
          (if (not narrow-p)
              (setq html-text
                    ...
                    (condition-case nil
                        (wenshan-retrieve-html-body (org-export-as-html nil nil nil 'string nil nil))
                      (wrong-number-of-arguments
                       (wenshan-retrieve-html-body (org-export-as-html nil nil 'string nil nil)))))
            (setq html-text
                  (wenshan-retrieve-html-body (org-export-region-as-html
